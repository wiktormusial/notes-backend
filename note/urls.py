...
urlpatterns = [
    ...
    path('categories', CategoriesViewSet.as_view({'get': 'list', 'post': 'create'}), name="categories"),
    path('categories/<int:pk>', CategoriesViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name="categories"),
]
